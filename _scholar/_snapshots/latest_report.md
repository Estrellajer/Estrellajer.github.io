...
- [🙋🏻‍♂️关于 | Chenxu's Blog](https://www.chenxutalk.top/about/): `Fetch/extract failed: HTTPSConnectionPool(host='www.chenxutalk.top', port=443): Max retries exceeded with url: /about/ (Caused by ProtocolError('Connection aborted.', ConnectionResetError(104, 'Connection reset by peer')))`
- [YY Blog](https://yqqy.top/nav): `Fetch/extract failed: HTTPSConnectionPool(host='yqqy.top', port=443): Max retries exceeded with url: /nav (Caused by ProtocolError('Connection aborted.', ConnectionResetError(104, 'Connection reset by peer')))`
- [Xiongda Blog](https://www.xxrbear.cn/): `Fetch/extract failed: HTTPSConnectionPool(host='www.xxrbear.cn', port=443): Max retries exceeded with url: / (Caused by ProtocolError('Connection aborted.', ConnectionResetError(104, 'Connection reset by peer')))`